...
public class DealStepsDefinitionsForDifferentAccounts {
	WebDriver driver;
	...
	public void user_enters_Title_and_Description_and_Propability(DataTable td) throws InterruptedException {
		List<Map<String,String>> str = td.asMaps(String.class, String.class);
		for(Map<String, String> map : str) {
			Thread.sleep(5000);
			driver.findElement(By.xpath("//input[@name='title']")).sendKeys(map.get("Title"));
			driver.findElement(By.xpath("//textarea[@name='description']")).sendKeys(map.get("Description"));
			driver.findElement(By.xpath("//input[@name='probability']")).sendKeys(map.get("Propability"));
